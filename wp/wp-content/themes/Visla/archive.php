			...
			<div id="content">
				...
				<div class="entry" id="post-<?php the_ID(); ?>">
					...
					<div class="entry-content">
						...
						<p><?php comments_popup_link('نظر شما چیست!', '1 دیدگاه', '% دیدگاه'); ?> | <a href="<?php the_permalink() ?>">بازم بخونید!</a></p>
					</div><!-- e: entry content -->
				</div><!-- e: entry -->
				...
				<p class="center">متاسفیم، ولی شما به دنبال چیزی هستید که این ورا پیدا نمیشه!</p>
				<?php get_search_form(); ?>
